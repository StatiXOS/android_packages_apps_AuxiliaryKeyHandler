...
import com.statix.auxiliarykeyhandler.R
import com.statix.auxiliarykeyhandler.actions.AuxiliaryActionType
import com.statix.auxiliarykeyhandler.extensions.systemService

class AuxiliaryKeyHandler(private val context: Context) : DeviceKeyHandler {

    private val resources = context.packageManager.getResourcesForApplication("com.statix.auxiliarykeyhandler")
